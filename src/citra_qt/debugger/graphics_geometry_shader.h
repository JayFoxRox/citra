...
class GraphicsGeometryShaderWidget;

class GraphicsGeometryShaderModel : public QAbstractTableModel {
    Q_OBJECT

public:
    GraphicsGeometryShaderModel(GraphicsGeometryShaderWidget* parent);
...
private:
    GraphicsGeometryShaderWidget* par;

    friend class GraphicsGeometryShaderWidget;
};

class GraphicsGeometryShaderWidget : public BreakPointObserverDock {
    Q_OBJECT

    using Event = Pica::DebugContext::Event;

public:
    GraphicsGeometryShaderWidget(std::shared_ptr<Pica::DebugContext> debug_context,
...
private:
    ...
    GraphicsGeometryShaderModel* model;
    ...
    friend class GraphicsGeometryShaderModel;
};
